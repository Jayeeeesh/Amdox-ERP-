...
const options = {
  definition: {
    ...
    info: {
      title: "Amdox ERP API",
      version: "1.0.0",
      description: "AI-Powered Cloud ERP Suite REST API Documentation",
      contact: {
        name: "Amdox Team",
      },
    },
    ...
    tags: [
      ...
      { name: "HR", description: "HR Module APIs" },
      { name: "Finance", description: "Finance Module APIs" },
      { name: "Supply Chain", description: "Supply Chain & Procurement APIs" },
